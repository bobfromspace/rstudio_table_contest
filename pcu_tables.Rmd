...
\begin{titlepage}
  ...
  \begin{abstract}
    This submission explores a way to render hierarchically structured multiple tables as one document in print-ready file format. The tables for this submission concern the representation of the parties and the type of available variables broken down by geographic regions and countries in V-Party dataset using R \emph{kable} and \emph{kableExtra} packages.
